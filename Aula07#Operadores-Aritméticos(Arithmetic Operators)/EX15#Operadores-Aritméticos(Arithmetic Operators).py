...
# 15 - Write a program that asks for the number of kilometers driven by a rental car and the number of days it was
# rented. Calculate the price to pay, knowing the car costs R$60.00 per day and R$0.15 per kilometer.
